...
async def send_course(chat_id):
    ...
    await send_message(chat_id,
        ...
        "Женщина-творец — это та, кто создаёт реальность не усилием воли, а из этой глубины. Она не подстраивается под мир, она формирует его. Её хореография — это язык, которым говорит архетип (изначальный образ, живущий в коллективном бессознательном): я здесь, я знаю, я создаю.\n\n"
